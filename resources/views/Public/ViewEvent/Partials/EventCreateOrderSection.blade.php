                ...
                <div class="row">
                    <div class="col-xs-6">
                        <div class="form-group">
                            ...
                            {!! Form::text("order_first_name", Auth::user()? Auth::user()->first_name : null, ['required' => 'required', 'class' => 'form-control']) !!}
                        </div>
                    </div>
                    <div class="col-xs-6">
                        <div class="form-group">
                            {!! Form::label("order_last_name", 'Last Name') !!}
                            {!! Form::text("order_last_name", Auth::user()? Auth::user()->last_name : null, ['required' => 'required', 'class' => 'form-control']) !!}
                        </div>
                    </div>
                </div>
                ...
                <div class="row">
                    <div class="col-md-12">
                        <div class="form-group">
                            ...
                            {!! Form::text("order_email", Auth::user()? Auth::user()->email : null, ['required' => 'required', 'class' => 'form-control']) !!}
                        </div>
                    </div>
                </div>
                </div>
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <div class="form-group">
                                    ...
                                    <input type="text" autocomplete="off" placeholder="**** **** **** ****" class="form-control card-number" size="20" data-stripe="number">
                                </div>
                            </div>
                        </div>
                        <div class="row">
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <div class="form-group">
                                    ...
                                    <input placeholder="***" class="form-control card-cvc" data-stripe="cvc">
                                </div>
                            </div>
                        </div>
                        <div class="row">
                            <div class="col-md-12">
                                <div class="form-group">
                                    ...
                                    {!! Form::text("promo_code", null, ['class' => 'form-control promo-code', 'placeholder'=>'E.g: 12345678(optional)']) !!}
                                </div>
                            </div>
                        </div>
                    </div>

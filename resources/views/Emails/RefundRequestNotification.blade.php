...
You have received refund request for the event <b>{{$order->event->title}}</b>.<br><br>
...
<div style="padding:10px; background: #F9F9F9; border: 1px solid #f1f1f1;">
    ...
    <br><br>
    You can manage this refund request at: {{route('showEventOrders', ['event_id' => $order->event->id, 'q'=>$order->order_reference])}}
    <br><br>
</div>
<br><br>
Thank you

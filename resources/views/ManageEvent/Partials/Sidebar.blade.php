<aside class="sidebar sidebar-left sidebar-menu">
    <section class="content">
        ...
        <ul id="nav_main" class="topmenu">
            <li>
                <a href="{{route('showOrganiserDashboard', ['organiser_id' => $event->organiser->id])}}">
                    ...
                    <span class="text">Back To Events</span>
                </a>
            </li>
        </ul>
        ...
        <ul id="nav_event" class="topmenu">
            ...
            @endrole
            <li class="{{ Request::is('*my_tickets*') ? 'active' : '' }}">
                <a href="{{route('showMyTickets', array('event_id' => $event->id))}}">
                    <span class="figure"><i class="ico-ticket"></i></span>
            ...
            <li class="{{ Request::is('*promo_codes*') ? 'active' : '' }}">
                <a href="{{route('showPromoCodes', array('event_id' => $event->id))}}">
                    <span class="figure"><i class="ico-scissors"></i></span>
            ...
            <li class="{{ Request::is('*breakout_sessions*') ? 'active' : '' }}">
                <a href="{{route('showBreakoutSessions', array('event_id' => $event->id))}}">
                    <span class="figure"><i class="ico-calendar"></i></span>
                    <span class="text">Breakout Sessions</span>
                </a>
            </li>
            <li class="{{ Request::is('*meals*') ? 'active' : '' }}">
                <a href="{{route('showMeals', array('event_id' => $event->id))}}">
                    <span class="figure"><i class="ico-food3"></i></span>

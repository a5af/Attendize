        ...
        <div class="modal-content">
            <div class="modal-header text-center">
                ...
                <h3 class="modal-title">
                    <i class="ico-cart"></i>
                    Refund Request: <b>{{$order->order_reference}}</b></h3>
            </div>
            ...
            <div class="modal-footer">
                <span class="refundRequest btn btn-success" data-route="{{route('confirmRefundRequest', ['order_id'=>$order->id])}}">Refund</span>
                <span class="refundRequest btn btn-success" data-route="{{route('denyRefundRequest', ['order_id'=>$order->id])}}">Deny</span>

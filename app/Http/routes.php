...
Route::group(['middleware' => ['installed']], function () {
    ...
    */
    Route::get('login/sso', [
        'as' => 'sso',
        'uses' => 'UserLoginController@handleSSO',
    ]);
...
Route::group(['prefix' => 'e'], function () {
    ...
    Route::get('/promo-code/100-percent-off', [
      'as'   => 'check100PercentOffPromoCode',
      'uses' => 'EventCheckoutController@check100PercentOffPromoCode',
    ]);
...
Route::group(['middleware' => ['auth', 'first.run']], function () {
    ...
    Route::group(['prefix' => 'event'], function () {
         ...
         * My Tickets
         */
        Route::get('{event_id}/my_tickets', [
            'as'   => 'showMyTickets',
            'uses' => 'MyTicketsController@showMyTickets'
        ]);
        Route::get('{event_id}/my_tickets/assign/{attendee_id}', [
            'as'   => 'showAssignTicket',
            'uses' => 'MyTicketsController@showAssignTicket'
        ]);
        Route::post('{event_id}/my_tickets/assign/{attendee_id}', [
            'as'   => 'postAssignTicket',
            'uses' => 'MyTicketsController@postAssignTicket'
        ]);
        Route::get('{event_id}/my_tickets/join/{attendee_id}', [
            'as'   => 'showJoinBreakoutSession',
            'uses' => 'MyTicketsController@showJoinBreakoutSession'
        ]);
        Route::post('{event_id}/my_tickets/join/{attendee_id}', [
            'as'   => 'postJoinBreakoutSession',
            'uses' => 'MyTicketsController@postJoinBreakoutSession'
        ]);

        /*
         * Ticket promo-codes
         */
        Route::get('{event_id}/promo_codes', [
            'as'   => 'showPromoCodes',
            'uses' => 'EventPromoCodesController@showPromoCodes'
        ]);
        Route::get('{event_id}/promo_codes/create', [
            'as'   => 'showCreatePromoCode',
            'uses' => 'EventPromoCodesController@showCreatePromoCode',
        ]);
        Route::post('{event_id}/promo_codes/create', [
            'as'   => 'postCreatePromoCode',
            'uses' => 'EventPromoCodesController@postCreatePromoCode',
        ]);
        Route::get('{event_id}/promo_codes/export/{export_as?}', [
            'as'   => 'showExportPromoCodes',
            'uses' => 'EventPromoCodesController@showExportPromoCodes',
        ]);

        /*
         * Breakout Sessions
         */
        Route::get('{event_id}/breakout_sessions', [
            'as'   => 'showBreakoutSessions',
            'uses' => 'EventBreakoutSessionsController@showBreakoutSessions'
        ]);
        Route::get('{event_id}/breakout_sessions/create', [
            'as'   => 'showCreateBreakoutSession',
            'uses' => 'EventBreakoutSessionsController@showCreateBreakoutSession',
        ]);
        Route::post('{event_id}/breakout_sessions/create', [
            'as'   => 'postCreateBreakoutSession',
            'uses' => 'EventBreakoutSessionsController@postCreateBreakoutSession',
        ]);
        Route::get('{event_id}/breakout_sessions/export/{export_as?}', [
            'as'   => 'showExportBreakoutSession',
            'uses' => 'EventBreakoutSessionsController@showExportBreakoutSession'
        ]);
        Route::get('{event_id}/breakout_sessions/{breakout_session_id}/edit', [
            'as'   => 'showEditBreakoutSession',
            'uses' => 'EventBreakoutSessionsController@showEditBreakoutSession',
        ]);
        Route::post('{event_id}/breakout_sessions/{breakout_session_id}/edit', [
            'as'   => 'postEditBreakoutSession',
            'uses' => 'EventBreakoutSessionsController@postEditBreakoutSession',
        ]);
        Route::get('{event_id}/breakout_sessions/{breakout_session_id}/delete', [
            'as'   => 'showDeleteBreakoutSession',
            'uses' => 'EventBreakoutSessionsController@showDeleteBreakoutSession',
        ]);
        Route::post('{event_id}/breakout_sessions/{breakout_session_id}/delete', [
            'as'   => 'postDeleteBreakoutSession',
            'uses' => 'EventBreakoutSessionsController@postDeleteBreakoutSession',
        ]);

        /*
         * Meals
         */
        Route::get('{event_id}/meals', [
          'as'   => 'showMeals',
          'uses' => 'EventMealsController@showMeals'
        ]);

        Route::get('{event_id}/meals/create', [
          'as'   => 'showCreateMeal',
          'uses' => 'EventMealsController@showCreateMeal'
        ]);
        Route::post('{event_id}/meals/create', [
          'as'   => 'postCreateMeal',
          'uses' => 'EventMealsController@postCreateMeal'
        ]);
        Route::get('{event_id}/meals//{meal_id}/edit', [
          'as'   => 'showEditMeal',
          'uses' => 'EventMealsController@showEditMeal'
        ]);
        Route::post('{event_id}/meals/{meal_id}/edit', [
          'as'   => 'postEditMeal',
          'uses' => 'EventMealsController@postEditMeal'
        ]);
        Route::get('{event_id}/meals/{meal_id}/delete', [
          'as'   => 'showDeleteMeal',
          'uses' => 'EventMealsController@showDeleteMeal'
        ]);
        Route::post('{event_id}/meals/{meal_id}/delete', [
          'as'   => 'postDeleteMeal',
          'uses' => 'EventMealsController@postDeleteMeal'
        ]);
        /*
         * -------
         * Attendees
        ...
        Route::get('order/{order_id}/request_refund', [
            'as'   => 'showRequestRefund',
            'uses' => 'EventOrdersController@showRequestRefund',
        ]);

        Route::post('order/{order_id}/request_refund', [
            'as'   => 'postRequestRefund',
            'uses' => 'EventOrdersController@postRequestRefund',
        ]);

        Route::get('order/{order_id}/cancel_request_refund', [
            'as'   => 'showCancelRequestRefund',
            'uses' => 'EventOrdersController@showCancelRequestRefund',
        ]);

        Route::post('order/{order_id}/cancel_request_refund', [
            'as'   => 'postCancelRequestRefund',
            'uses' => 'EventOrdersController@postCancelRequestRefund',
        ]);

        Route::get('order/{order_id}/manage_refund_request', [
            'as'   => 'showManageRefundRequest',
            'uses' => 'EventOrdersController@showManageRefundRequest',
        ]);

        Route::get('order/{order_id}/confirm_refund_request', [
            'as'   => 'confirmRefundRequest',
            'uses' => 'EventOrdersController@confirmRefundRequest',
        ]);

        Route::get('order/{order_id}/deny_refund_request', [
            'as'   => 'denyRefundRequest',
            'uses' => 'EventOrdersController@denyRefundRequest',
        ]);
